 ...
 */
package com.solrsession.core.constants;

/**
 * Global class for all SolrSessionCore constants. You can add global constants for your extension into this class.
 */
public final class SolrSessionCoreConstants extends GeneratedSolrSessionCoreConstants
{
	public static final String EXTENSIONNAME = "SolrSessioncore";


	private SolrSessionCoreConstants()
	{
		//empty
	}
