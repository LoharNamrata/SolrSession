 ...
 */
package com.solrsession.test.setup;
...
import com.solrsession.test.constants.SolrSessionTestConstants;
import com.solrsession.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SolrSessionTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/SolrSessiontest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/SolrSessiontest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/SolrSessiontest/import/cstickets.impex");
			...
			importImpexFile(context, "/SolrSessiontest/import/csquotes.impex");
		}
	}
}
