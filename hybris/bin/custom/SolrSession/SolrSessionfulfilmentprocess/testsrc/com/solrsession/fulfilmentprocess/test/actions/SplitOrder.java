 ...
 */
package com.solrsession.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SolrSessionFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SolrSessionFulfilmentProcessConstants.PARENT_PROCESS);
