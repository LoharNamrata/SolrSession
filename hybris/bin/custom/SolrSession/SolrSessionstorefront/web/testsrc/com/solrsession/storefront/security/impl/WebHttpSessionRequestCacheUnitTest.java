...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/SolrSessionstorefront/electronics/en",
						"https://electronics.local:9002/SolrSessionstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/SolrSessionstorefront/electronics/en",
						"https://electronics.local:9002/SolrSessionstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/SolrSessionstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/SolrSessionstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/SolrSessionstorefront/electronics/en",
						"https://electronics.local:9002/SolrSessionstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/SolrSessionstorefront",
						"https://electronics.local:9002/SolrSessionstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/SolrSessionstorefront",
						"https://electronics.local:9002/SolrSessionstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/SolrSessionstorefront/electronics/en",
						"https://electronics.local:9002/SolrSessionstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
